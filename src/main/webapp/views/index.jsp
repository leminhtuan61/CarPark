		...
		<div class="col-md-9" id="mainContents">
			...
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-md-12">
							<div class="row" style="margin-top: 30px" id="context">
								<h2>Employee List</h2>
								...
								<table class="table" border="1" cellpadding="5" cellspacing="5">
									...
									<table>
										<ul class="pagination">
											<x:choose>
												<x:when test="${currentPage !=1 }">
													<li class="page-item"><a class="page-link"
														href="list?page=${currentPage-1}">Previous</a></li>
												</x:when>
											...
											<x:chose>
												<x:when test="${currentPage != totalPage }">
													<li class="page-item"><a class="page-link"
														href="list?page=${currentPage+1 }">Next</a></li>
												</x:when>
